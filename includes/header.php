...
<body>
    <style>
        ...
        .dropdown-menu .dropdown-item:hover {
            background-color: #495057; /* Fundo cinza ao passar o mouse */
        }

        .dropdown-menu .dropdown-item.text-danger {
            color: #dc3545; /* Texto vermelho para "Terminar Sessão" */
        }

        .dropdown-menu .dropdown-item.text-danger:hover {
            background-color: #bd2130; /* Fundo vermelho escuro ao passar o mouse */
        }
        ...
        .nav-button.login-button {
            background-color: #ff7043; /* Vermelho claro meio para o laranja */
            color: #fff; /* Texto branco */
            padding: 10px 20px; /* Espaçamento interno */
            text-decoration: none; /* Remove o sublinhado */
            border-radius: 5px; /* Bordas arredondadas */
        ...
        <nav>
            <ul class="nav-menu">
                ...
                <?php if (isset($_SESSION['username'])): ?>
                    <li><a href="equipas.php" class="nav-button">Equipas</a></li>
